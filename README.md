...
TO compare the calculations from KL with those from Craig, use this figure:
<img src = "https://github.com/redbluewater/BATSallTime_LTT/blob/main/BATS_bvfrq_cfKLandCC.jpg" width="75%" height="75%"> 
