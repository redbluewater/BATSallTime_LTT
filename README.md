...
The primary m-file is written in MATLAB: ([getBATSdata_LTT_KLv1.m](https://github.com/redbluewater/BATSallTime_LTT/blob/main/getBATSdata_LTT_KLv1.m)), and you can follow the link if you want to see what I did. That m-file calls a few other m-files, all of which are here in GitHub.
